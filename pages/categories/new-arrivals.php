...
$sql = "SELECT p.*, MIN(pf.fabric_price) as min_price, SUM(pf.fabric_qty) as total_qty
        ...
        WHERE p.created BETWEEN '" . date('Y-m-d', strtotime('-1 month')) . " 00:00:00' AND '" . date('Y-m-d') . " 23:59:59' AND p.is_deleted = 0";
...
$sql .= " GROUP BY p.id ORDER BY p.created DESC";
    ...
    <div class="container">
        ...
        <div class="page-layout">
            ...
            <div class="sidebar-col">
                ...
                include __DIR__ . '/../../includes/filter-sidebar.php'; 
                ?>
            </div>
                ...
                <?php else: ?>
                    ...
                    <div class="no-results">
                        <div class="no-results-content">
                            ...
                            <a href="new-arrivals.php" class="btn-back-home">Clear Filters</a>
                        </div>
                    </div>
                <?php endif; ?>
            </div>
