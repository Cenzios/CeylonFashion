...
<div class="modal-product-view-container">
    ...
    <div class="mp-row">
                ...
                <div class="mp-slider-wrapper">
                    <?php foreach ($images as $idx => $img): ?>
                        <div class="mp-slide <?php echo $idx === 0 ? 'active' : ''; ?>" data-idx="<?php echo $idx; ?>">
                            <img src="../../assets/images/products/<?php echo htmlspecialchars($img); ?>" alt="Product Image">
                        </div>
                    <?php endforeach; ?>
                </div>
        ...
        <div class="mp-col-right">
            ...
            <form id="quickAddForm" action="../../handlers/cart/cart-add.php" method="GET" onsubmit="return handleQuickAdd(this);">
            ...
            <a href="../../pages/products/product-view.php?id=<?php echo $product_id; ?>" class="mp-btn-view-full">VIEW FULL DETAILS</a>
        </div>
    </div>
</div>
...
<script>
    ...
    function handleQuickAdd(form) {
        ...
        fetch('../../handlers/cart/cart-add.php?' + params + '&ajax=1')
          .then(res => res.json())
          .then(data => {
              if (data.status === 'ok') {
