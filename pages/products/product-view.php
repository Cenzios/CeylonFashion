...
require_once __DIR__ . '/../../components/reviews-handler.php';
...
<div class="product-container">
  <div class="product-top">
    ...
    <div class="left-col">
      <div class="image-layout">
        <div class="main-image">
          <img id="mainProductImage" src="../../assets/images/products/<?= e($images[0]); ?>" alt="<?= e($product['product_name']); ?>">
        </div>
        ...
        <div class="thumbs-col">
          <?php foreach ($images as $idx => $img): ?>
            <div class="thumb-item <?= $idx === 0 ? 'active' : ''; ?>" data-img="<?= e($img); ?>">
              <img src="../../assets/images/products/<?= e($img); ?>" alt="<?= e($product['product_name']); ?>">
            </div>
          <?php endforeach; ?>
        </div>
      </div>
    ...
    <div class="right-col">
      ...
      <!-- Action Form -->
      <form id="addToCartForm" action="../../handlers/cart/cart-add.php" method="GET" onsubmit="return prepareCartForm(this);">
  ...
  <div class="reviews-section">
    ...
    include __DIR__ . '/../../components/reviews-section.php'; 
...
include __DIR__ . '/../../components/review-dialog.php'; 
?>
...
<?php include __DIR__ . '/../../includes/login-sidebar.php'; ?>
<!-- Size Guide Modal -->
...
<!-- Login/Register Sidebars -->
<?php include __DIR__ . '/../../includes/register-sidebar.php'; ?>
...
<script>
  ...
  function toggleWishlist(productId) {
    ...
    if (btn) {
      fetch('../../handlers/wishlist/wishlist-toggle.php?id=' + productId)
        .then(r => r.json())
        .then(data => {
          if (data.status === 'ok') {
  ...
  document.addEventListener('DOMContentLoaded', () => {
      ...
      thumbs.forEach(thumb => {
          thumb.addEventListener('click', () => {
              ...
              mainImage.src = '../../assets/images/products/' + src;
          });
      });
...
<script>
  ...
  function updateLightboxImage() {
    ...
    const newSrc = '../../assets/images/products/' + productImages[currentLbIndex];
