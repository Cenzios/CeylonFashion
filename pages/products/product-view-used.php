...
// Images
$img1 = !empty($product['product_img1']) ? '../../assets/images/products/' . $product['product_img1'] : '../../assets/no-image.png';
$img2 = !empty($product['product_img2']) ? '../../assets/images/products/' . $product['product_img2'] : '';
$img3 = !empty($product['product_img3']) ? '../../assets/images/products/' . $product['product_img3'] : '';
$img4 = !empty($product['product_img4']) ? '../../assets/images/products/' . $product['product_img4'] : '';
